...
class BasePageLocators:
    ...
    SEARCH_FIELD = (By.XPATH, '//input[@data-tsid="toolbar-search-input"]')
    VK_ECOSYSTEM_BUTTON = (By.XPATH, '//span[@class="toolbar_nav_i_ic"]')
...
class BasePageHelper:
    ...
    @allure.step('Получаем номер страницы')
    def get_windows_id(self, index):
        return self.driver.window_handles[index]

    @allure.step('Переключаемся на выбранную страницу')
